...
public class FootIKSimple : MonoBehaviour
{
    ...
    public float rayAbove = 0.6f, rayBelow = 1f;
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        bool lHit = Physics.Raycast(lPose + Vector3.up * rayAbove, Vector3.down, out  RaycastHit l, rayAbove + rayBelow, groundMask, QueryTriggerInteraction.Ignore);
        bool rHit = Physics.Raycast(rPose + Vector3.up * rayAbove, Vector3.down, out  RaycastHit r, rayAbove + rayBelow, groundMask, QueryTriggerInteraction.Ignore);
        ...
        Quaternion lGoalRot = lHit? 
            Quaternion.FromToRotation(Vector3.up, l.normal) * animator.GetIKRotation(AvatarIKGoal.LeftFoot) : animator.GetIKRotation(AvatarIKGoal.LeftFoot);
        Quaternion rGoalRot = rHit ?
            Quaternion.FromToRotation(Vector3.up, r.normal) * animator.GetIKRotation(AvatarIKGoal.RightFoot) : animator.GetIKRotation(AvatarIKGoal.RightFoot);
